...
# ✨ hey, i'm **Suseenthiran Arulraj Rumeasiyan** ✨
...
> based in **Sri Lanka** 🇱🇰 — shipping for the world
...
<td><strong>Gear UP</strong> — sports court & activity booking platform</td>
</tr>
<tr>
<td align="center">💳</td>
<td><strong>Lead Software Engineer</strong></td>
...
> no i don't sleep. next question 😭
...
> yes i publish. yes it's backed by actual institutions. slay 💅

| publication | venue | year |
|-------------|-------|------|
| 📄 **EMS360** — AI-powered Education Management Ecosystem | BP-IPAG Symposium 2025 | 2025 |
| 📄 **SCOApp** — Smart Cloud Office Platform for Public Administration | BP-IPAG Symposium 2025 | 2025 |
| 📄 **ResolveQ** — AI-Powered Complaint Management System for Governance | BP-IPAG Symposium 2025 | 2025 |
| 📄 **ChemNexus AI** — AI-Powered Educational Platform | BP-IPAG Symposium 2025 | 2025 |
...
> giving back is part of the stack fr 🌍
...
<tr>
<td>🦊</td>
<td><strong>Mozilla Campus Club Member</strong> — open web advocacy</td>
</tr>
</table>
...
## 🛠️ the tech stack (the weapon loadout)
...
i'm not really interested in building software that just looks cool in screenshots.

i like building:

```
🔒  systems that teams can depend on
📈  platforms that scale with real operations
🎯  products that reduce chaos and ambiguity
⚡  tools that make humans faster, clearer, and more effective
```

i can go from **idea → architecture → development → deployment → delivery** without losing the plot. comfortable with both greenfield products and messy real-world systems. backend, frontend, infra, AI, product logic — all of it.

so yeah — i'm here to build **useful**, **smart**, and **well-architected** things 😌
...
and if you need someone who can actually execute — not just talk about it — you know where to find me 😌

---

<div align="center">

### ⚡ building useful systems > building noise

**Architect brain 🧠 • Builder hands 🛠️ • Founder energy 🚀**

_from 🇱🇰 to the world — one commit at a time_
...
![Profile Views](https://komarev.com/ghpvc/?username=Rumeasiyan&color=6366f1&style=for-the-badge&label=profile+views)
